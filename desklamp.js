...
/***/ function(module, exports, __webpack_require__) {
	...
	var Container = function (_React$Component) {
	  ...
	  _createClass(Container, [{
	    ...
	    key: 'on',
	    value: function on(initState, userFuncs, routeProps, navbar) {
	      var _this3 = this;
	      ...
	      var propsUpdate = {};
	      if (routeProps) {
	        Object.keys(routeProps).forEach(function (key) {
	          propsUpdate[key] = {};
	          Object.keys(routeProps[key]).forEach(function (arrKey) {
	            routeProps[key][arrKey].forEach(function (item) {
	              var pull = arrKey === 'state' ? 'appState' : 'userFunctions';
	              propsUpdate[key][item] = _this3.state[pull][item];
	            });
	          });
	        });
	      }
	    ...
	    value: function render() {
	      ...
	      var inputs = this.state.routeStates[window.location.hash.replace('#/', '').toLowerCase()];
	      return _react2.default.createElement(
	        'div',
	        null,
	        navBar,
